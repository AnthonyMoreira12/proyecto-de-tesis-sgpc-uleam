<template>
  <div
    class="sgpc-pub-search"
    role="search"
  >
    <span
      class="sgpc-pub-search__icon"
      aria-hidden="true"
    >
...
.sgpc-pub-search:hover {
  border-color:
    var(--border-strong, #bcc8d7);
}

.sgpc-pub-search:focus-within {
  border-color:
    var(
...
.sgpc-pub-search__input::placeholder {
  color:
...
.sgpc-pub-search__clear:focus-visible {
  outline:
    2px solid
    var(
      --color-primary-effective,
